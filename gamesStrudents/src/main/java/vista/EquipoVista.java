...
public void setTxtCodigo(String texto) {
...
public JTextField getTxtPaisProcedencia() {
    return txtPaisProcedencia;
}

public void setTxtPaisProcedencia(String texto) {
    txtPaisProcedencia.setText(texto);
}

public JTextField getTxtFechaFundacion() {
    return txtFechaFundacion;
}

public void setTxtFechaFundacion(String texto) {
    txtFechaFundacion.setText(texto);
}

public JTextField getTxtEntrenador() {
    return txtEntrenador;
}

public void setTxtEntrenador(String texto) {
    txtEntrenador.setText(texto);
}
...
public JButton getBtnSalir() {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Gestion Equipo");
        ...
        IdEquipo.setText("Fecha fundación:");

        jLabel4.setBackground(new java.awt.Color(204, 204, 204));
        jLabel4.setFont(new java.awt.Font("Segoe UI", 1, 14)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("País procedencia:");
        ...
        lol.setText("Entrenador: ");

        txtPaisProcedencia.setForeground(new java.awt.Color(153, 153, 153));

        txtNombre.setForeground(new java.awt.Color(153, 153, 153));

        txtFechaFundacion.setForeground(new java.awt.Color(153, 153, 153));

        txtEntrenador.setForeground(new java.awt.Color(153, 153, 153));
                    ...
                    .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(javax.swing.GroupLayout.Alignment.LEADING, layout.createSequentialGroup()
                            ...
                            .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                .addComponent(txtCodigo, javax.swing.GroupLayout.DEFAULT_SIZE, 204, Short.MAX_VALUE)
                                .addComponent(txtNombre)
                                .addComponent(txtPaisProcedencia)
    ...
    private javax.swing.JTextField txtPaisProcedencia;
